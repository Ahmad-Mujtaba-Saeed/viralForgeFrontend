 ...
 *
 * Where Aurora is a dark violet–cyan night, this variant is the opposite
 * pole: near-white frosted glass floating over a soft pastel prism mesh,
 * with iridescent (blue→lilac→pink→peach) accents and specular highlights.
 * The language is Apple's "Liquid Glass" — ultra-clear panels, physical
 * lozenge buttons, light refraction and holographic hover sheens.
 *
...
function PrismBackdrop({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  ...
  return (
    <div
      ...
      style={{ background: `linear-gradient(180deg, ${C.bgSoft}, ${C.bg})` }}
      aria-hidden="true"
    >
      <div className="prism-pool prism-pool-a" />
      <div className="prism-pool prism-pool-b" />
      <div className="prism-pool prism-pool-d" />
      <motion.div className="prism-pool prism-pool-c" style={{ y: orbY }} />
      ...
      <style jsx>{`
        ...
        .prism-pool-a {
          ...
          top: -16vw;
          left: -10vw;
          background: radial-gradient(circle at 50% 50%, rgba(91, 140, 255, 0.5), transparent 66%);
          animation: pool-a 26s ease-in-out infinite alternate;
        }
        .prism-pool-b {
          width: 50vw;
          height: 50vw;
          top: -8vw;
          right: -12vw;
          background: radial-gradient(circle at 50% 50%, rgba(255, 111, 207, 0.42), transparent 66%);
        ...
        .prism-pool-c {
          ...
          top: 34%;
          left: 40%;
          background: radial-gradient(circle at 50% 50%, rgba(155, 124, 255, 0.42), transparent 66%);
          animation: pool-c 24s ease-in-out infinite alternate;
        }
        .prism-pool-d {
          width: 42vw;
          height: 42vw;
          bottom: -16vw;
          left: -8vw;
          background: radial-gradient(circle at 50% 50%, rgba(84, 227, 198, 0.34), transparent 66%);
          animation: pool-d 32s ease-in-out infinite alternate;
        }
        @keyframes pool-a {
        ...
        @keyframes pool-b {
          ...
          to   { transform: translate3d(-8vw, 5vh, 0) scale(1); }
        }
        @keyframes pool-c {
...
function Holo({
  ...
  const sheen = useTransform(
    [mx, my] as const,
    ([x, y]: number[]) =>
      `radial-gradient(240px circle at ${x}px ${y}px, rgba(91,140,255,0.20), rgba(255,111,207,0.14) 42%, transparent 72%)`
  )
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden shadow-[0_18px_50px_-24px_rgba(30,26,90,0.35)] ${glassCard} ${className}`}
    >
      <motion.div
...
function Lozenge({
  ...
  if (primary) {
    return (
      <Link
        href={href}
        className={`group relative inline-flex h-12 items-center gap-2 overflow-hidden rounded-full px-6 text-[14.5px] font-bold text-white transition-transform hover:scale-[1.03] ${className}`}
        style={{
          background: CTA_GRAD,
          boxShadow: `0 14px 40px -12px ${C.violet}, inset 0 1px 0 rgba(255,255,255,0.5)`,
        }}
      >
        {/* Top glass highlight */}
        <span
  ...
  return (
    <Link
      href={href}
      className={`inline-flex h-12 items-center gap-2 rounded-full border px-6 text-[14.5px] font-semibold backdrop-blur-xl transition-colors hover:bg-white/70 ${className}`}
      style={{
        color: C.ink,
        borderColor: C.line,
        background: C.glass,
...
function Navbar({ scrollY }: { scrollY: MotionValue<number> }) {
  ...
  React.useEffect(() => scrollY.on("change", (v) => setSolid(v > 24)), [scrollY])
    ...
    <header className="fixed inset-x-0 top-0 z-50">
        ...
        <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-2.5 md:flex">
            {ready && isAuthenticated ? (
              <Link
                href={LINKS.app}
                className="flex items-center gap-2.5 rounded-full border px-3 py-1.5 text-[13.5px] font-semibold backdrop-blur-xl transition-colors hover:bg-white/70"
              ...
              <>
                <Link
                  href={LINKS.signIn}
                  className="rounded-full px-3.5 py-2 text-[13.5px] font-semibold transition-colors hover:bg-white/60"
                  style={{ color: C.ink2 }}
                >
                  Sign in
                </Link>
                <Lozenge href={LINKS.start} primary className="h-10 px-4 text-[13.5px]">
                  Start free
                </Lozenge>
              </>
            )}
      ...
      {open && (
        <motion.div
          ...
          className="mx-4 mt-2 rounded-3xl border p-4 backdrop-blur-2xl md:hidden"
        ...
        >
          ...
          <Link
            ...
            className="mt-2 block rounded-full px-4 py-2.5 text-center text-sm font-bold text-white"
...
function Hero({
  ...
  // pane of glass receding as you dive through it into the content.
  const mockY = useTransform(scrollYProgress, [0, 0.18], [0, -60])
  const mockScale = useTransform(scrollYProgress, [0, 0.18], [1, 0.92])
  const mockRotate = useTransform(scrollYProgress, [0, 0.18], [0, -7])
  const mockOpacity = useTransform(scrollYProgress, [0, 0.16], [1, 0.4])
  ...
  return (
    <section className="relative px-4 pb-24 pt-36 sm:px-6 lg:px-8">
      <motion.div style={{ y: copyY }} className="mx-auto max-w-3xl text-center">
        <motion.div
        ...
        >
          <Lozenge href={ready && isAuthenticated ? LINKS.app : LINKS.start} primary className="group">
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: `0 50px 120px -34px rgba(40,32,110,0.45), inset 0 1px 0 rgba(255,255,255,0.9)`,
      }}
    >
      {/* Specular sweep — a diagonal glint that travels across the glass. */}
      <div className="specular pointer-events-none absolute inset-0" aria-hidden="true" />

      {/* Title bar */}
      <div className="relative flex items-center gap-2 border-b px-4 py-3" style={{ borderColor: C.lineSoft }}>
        <span className="h-2.5 w-2.5 rounded-full" style={{ background: C.pink }} />
        <span className="h-2.5 w-2.5 rounded-full" style={{ background: C.peach }} />
      ...
      <div className="relative grid gap-6 p-6 sm:grid-cols-[1.25fr_1fr]">
        <div>
          <div className="text-[11px] font-bold uppercase tracking-[0.12em]" style={{ color: C.ink3 }}>
            Template
          </div>
            ...
            {list.map((t, i) => {
              ...
              return (
                <div
                  ...
                  style={{
                    borderColor: active ? "rgba(124,92,255,0.4)" : C.lineSoft,
                    background: active ? "rgba(124,92,255,0.10)" : "rgba(255,255,255,0.5)",
                  }}
                >
                  <span
                    className="flex h-9 w-9 items-center justify-center rounded-xl"
                    style={{
                      background: active ? CTA_GRAD : "rgba(15,16,48,0.05)",
                  ...
                  {active && <Check className="ml-auto h-4 w-4 flex-shrink-0" style={{ color: C.violet }} />}
                </div>
              )
            })}
          </div>
          ...
          <div
            ...
            style={{ background: CTA_GRAD, boxShadow: `0 12px 34px -14px ${C.violet}` }}
          >
        ...
        <div className="flex items-center justify-center">
          <div
            ...
            style={{
              aspectRatio: "9 / 16",
              borderColor: C.line,
              background: "linear-gradient(165deg, #EEF0FF, #DDE6FF)",
              boxShadow: "inset 0 1px 0 rgba(255,255,255,0.9)",
            }}
          >
            <div
              className="absolute inset-x-0 top-0 h-24 opacity-70"
              style={{ background: `radial-gradient(circle at 50% 0%, ${C.lilac}, transparent 70%)` }}
            />
            <div className="absolute inset-x-3 top-1/2 -translate-y-1/2 text-center">
              <p className="text-[15px] font-extrabold leading-tight" style={{ color: C.ink }}>
                This <span style={{ color: C.pink }}>changed</span> everything
              </p>
            </div>
            <div className="absolute inset-x-3 bottom-3">
              <div className="h-1 overflow-hidden rounded-full" style={{ background: "rgba(15,16,48,0.1)" }}>
                <motion.div
        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="hidden lg:block">
            <div className="sticky top-28">
              <Holo className="p-8">
                <div className="font-display text-[13px] font-bold uppercase tracking-[0.14em]" style={{ color: C.ink3 }}>
                  The whole pipeline
                </div>
                  ...
                  {[
                    ...
                    >
                      <span
                        ...
                        style={{ background: "rgba(84,227,198,0.2)", color: "#12A98C" }}
                      >
                ...
                <div
                  ...
                  style={{
                    background: "linear-gradient(135deg, rgba(91,140,255,0.14), rgba(255,111,207,0.12))",
                    border: `1px solid ${C.line}`,
                  }}
                >
                  ...
                  <div className="font-display mt-1 text-[28px] font-bold" style={{ color: C.violet }}>
                    ~4 minutes
                  </div>
                </div>
              </Holo>
                ...
                <Holo className="p-7">
                  <div className="flex items-start gap-5">
                    <span
                      ...
                      style={{
                        background: i === 0 ? CTA_GRAD : "rgba(255,255,255,0.7)",
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2.5">
                        <s.icon className="h-4 w-4" style={{ color: C.violet }} />
                        <h3 className="font-display text-[19px] font-bold tracking-tight" style={{ color: C.ink }}>
                          {s.title}
                        </h3>
                      </div>
                      <p className="mt-2 text-[14px] leading-relaxed" style={{ color: C.ink2 }}>
            ...
            <motion.div key={f.title} variants={rise}>
              <Holo className="h-full p-6">
                <span
                  className="flex h-11 w-11 items-center justify-center rounded-2xl transition-transform duration-300 group-hover:scale-110"
                  style={{
                    background: "linear-gradient(135deg, rgba(91,140,255,0.22), rgba(255,111,207,0.18))",
                    border: `1px solid ${C.line}`,
                    color: C.violet,
                    boxShadow: "inset 0 1px 0 rgba(255,255,255,0.9)",
                  }}
                ...
                <h3 className="font-display mt-5 text-[17px] font-bold tracking-tight" style={{ color: C.ink }}>
                  {f.title}
                </h3>
    ...
    <section className="overflow-hidden py-24">
      ...
      <div className="relative mt-14">
        ...
        <div className="marquee flex gap-5">
          {loop.map((t, i) => (
            <figure key={`${t.name}-${i}`} className={`w-[340px] flex-shrink-0 p-6 ${glassCard}`}>
          ...
          >
            {(["month", "year"] as const).map((opt) => (
              <button
                ...
                className="cursor-pointer rounded-full px-5 py-2 text-[13.5px] font-bold transition-all"
                style={
                  interval === opt
              ...
              >
                ...
                {opt === "year" && <span className="ml-1.5 text-[11px] opacity-90">−25%</span>}
              </button>
            ))}
          </div>
        </div>
          ...
          {TIERS.map((t) => {
            ...
            return (
              <motion.div key={t.name} variants={rise} className="relative">
                {popular && (
                  <div
                    className="pointer-events-none absolute -inset-px rounded-[28px] opacity-70 blur-lg"
                ...
                <div
                  ...
                  style={
                    popular
                      ? { background: "rgba(255,255,255,0.78)", borderColor: "rgba(124,92,255,0.4)" }
                      : undefined
                  }
                >
                  {popular && (
                  ...
                  <div className="mt-4 flex items-end gap-1.5">
                    <span className="font-display text-[42px] font-bold leading-none tracking-tight" style={{ color: C.ink }}>
                      ${price(t)}
                    </span>
                  ...
                  <div
                    ...
                    style={{ background: "rgba(124,92,255,0.12)", color: C.violet }}
                  >
                  ...
                  <ul className="mt-6 space-y-2.5">
                    {t.features.map((f) => (
                      <li key={f} className="flex items-start gap-2.5">
                        <Check className="mt-0.5 h-4 w-4 flex-shrink-0" style={{ color: C.violet }} />
                  ...
                  <Link
                    ...
                    style={
                      popular
                        ? { background: CTA_GRAD, color: "#fff", boxShadow: `0 12px 34px -14px ${C.violet}` }
                        : { background: "rgba(255,255,255,0.7)", color: C.ink, border: `1px solid ${C.line}` }
                    }
                  >
                    Get {t.name}
                  </Link>
    ...
    <section className="px-4 py-24 sm:px-6 lg:px-8">
      ...
      >
        <div
          ...
          style={{ background: `radial-gradient(600px circle at 50% 0%, rgba(124,92,255,0.2), transparent 70%)` }}
        />
        <div className="relative">
          ...
          <p className="mx-auto mt-4 max-w-md text-[15.5px] leading-relaxed" style={{ color: C.ink2 }}>
...
export default function LandingLiquidGlass({
  ...
  return (
    ...
    >
      ...
      {/* Iridescent scroll-progress bar. */}
      <motion.div
